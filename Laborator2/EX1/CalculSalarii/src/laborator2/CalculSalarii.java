...
public class CalculSalarii {
    public static void main(String[] args){
        ...
        System.out.println(" Sofer " + sof1.toString() + " a lucrat " + sof1.getNrOreLucrate() + " ore, a parcurs " + sof1.getKmParcursi() + " km - salariu= " + sof1.salariu());



        IAngajat[] salariati= new IAngajat[]{ ing1, ing2, sof1};
